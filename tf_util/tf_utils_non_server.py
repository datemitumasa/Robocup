...
#        self._listener = tf2_ros.TransformListener(self._buffer)
        ...
        self._tf_flag = True
        self._tf_list = []
        rospy.Subscriber("/hsrb/battery_info", SanyoBatteryInfo, self.run)
    ...
    def lookup(self, base_tf, child_tf):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                print("wait for tf {} {}".format(base_tf, child_tf))
            count += 1
            if count > 100:
                return [], [], []
    ...
    def publish_start(self,):
        ...
        self._tf_flag = False
        self.sub = rospy.Subscriber("/hsrb/battery_info", SanyoBatteryInfo, self.run)
        while not rospy.is_shutdown():
            if self._tf_flag:
                break
