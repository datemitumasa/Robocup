...
class Grammar:
    ...
    def load(self, filename):
        lines = codecs.open(filename , "r" , "utf8").readlines() #文字コードを指定してファイルを読み書き
    ...
    def match(self, s):
        ...
        for id, g in self.grammars.items():
            ...
            if m:
                ...
                if matched_gramid==None or len(matched_noun)<len(noun):
                    matched_gramid = id
                    matched_noun = noun
                    mathced_nounid = [ self.noun2id[n] for n in matched_noun ]
...
def main():
    ...
    g.load( "testgram.txt" )
    print "----------------"
    print(g.match( "I want potato chips and green tea" ))
    print(g.match( "I want potato green tea and potato chips" ))
    print(g.match( "I want potato chips" ))
    print(g.match( "I want potato green tea" ))
    print(g.match( "I want potato" ))
